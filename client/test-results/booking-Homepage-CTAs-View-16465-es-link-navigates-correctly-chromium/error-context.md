...
- Name: booking.spec.ts >> Homepage CTAs >> View all experiences link navigates correctly
- Location: tests\e2e\booking.spec.ts:67:7
...
Call log:
  - waiting for getByRole('link', { name: /view all experiences/i })
