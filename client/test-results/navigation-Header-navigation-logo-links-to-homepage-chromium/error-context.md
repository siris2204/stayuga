...
- Name: navigation.spec.ts >> Header navigation >> logo links to homepage
...
Call log:
  - waiting for getByRole('link', { name: /stayuga/i }).first()
...
- generic [ref=e1]:
          ...
          - generic [ref=e50]:
            ...
            - generic [ref=e73]:
              ...
              - generic [ref=e85]:
                - generic [ref=e86]:
                  - text: getExperiences
                  - button "Open getExperiences in editor" [ref=e87] [cursor=pointer]
                - text: src\lib\data.ts (24:27)
              - generic [ref=e90]:
  ...
  - paragraph [ref=e137]: ERROR 205151630
```
