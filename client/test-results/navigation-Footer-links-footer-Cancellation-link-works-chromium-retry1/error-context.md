...
- Name: navigation.spec.ts >> Footer links >> footer Cancellation link works
- Location: tests\e2e\navigation.spec.ts:74:7
...
Call log:
  - waiting for getByRole('contentinfo').getByRole('link', { name: /cancellation/i })
