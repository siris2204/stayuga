...
- Name: filters.spec.ts >> Property filters >> Min guests input filters by capacity
- Location: tests\e2e\filters.spec.ts:34:7
...
Call log:
  - waiting for getByPlaceholder(/e\.g\. 10/i)
