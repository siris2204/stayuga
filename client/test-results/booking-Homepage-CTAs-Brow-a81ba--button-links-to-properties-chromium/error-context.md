...
- Name: booking.spec.ts >> Homepage CTAs >> Browse properties button links to /properties
- Location: tests\e2e\booking.spec.ts:58:7
...
Locator: getByRole('link', { name: /browse properties/i })
Expected: "/properties"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /browse properties/i })
