...
- Name: booking.spec.ts >> Homepage CTAs >> View all properties link navigates correctly
- Location: tests\e2e\booking.spec.ts:62:7
...
Call log:
  - waiting for getByRole('link', { name: /view all properties/i })
