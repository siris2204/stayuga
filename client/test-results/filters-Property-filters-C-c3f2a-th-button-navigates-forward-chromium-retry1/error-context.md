...
- Name: filters.spec.ts >> Property filters >> Calendar next month button navigates forward
- Location: tests\e2e\filters.spec.ts:56:7
...
Call log:
  - waiting for locator('span.text-sm.font-semibold.text-ink').first()
