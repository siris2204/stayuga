...
- Name: filters.spec.ts >> Property filters >> Apply filters button with no selection navigates to /properties
- Location: tests\e2e\filters.spec.ts:40:7
...
Call log:
  - waiting for getByRole('button', { name: /apply filters/i })
