...
- Name: filters.spec.ts >> Property filters >> All types radio clears type filter
- Location: tests\e2e\filters.spec.ts:20:7
...
Call log:
  - waiting for getByRole('radio', { name: 'All types' })
