...
- Name: filters.spec.ts >> Property filters >> Farmhouse radio button filters to farmhouses
- Location: tests\e2e\filters.spec.ts:14:7
...
Call log:
  - waiting for getByRole('radio', { name: 'Farmhouse' })
